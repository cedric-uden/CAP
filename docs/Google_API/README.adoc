...
image::03-go_to_sidebar_menu.png[]
+++ </div></details> +++
...
image::04-go_to_APIs_and_services.png[]
+++ </div></details> +++
...
image::05-go_to_activate_API_and_services.png[]
+++ </div></details> +++
...
image::06-search_for_youtube.png[]
+++ </div></details> +++
...
image::07-select_youtube_data_API.png[]
+++ </div></details> +++
...
image::08-activate_youtube_data_API.png[]
+++ </div></details> +++
...
image::09-head_back_to_APIs_and_services.png[]
+++ </div></details> +++
...
image::10-oauth_activation_screen.png[]
+++ </div></details> +++
...
image::12-enter_details_pt1.png[]
image::13-enter_details_pt2.png[]
+++ </div></details> +++
...
image::16-enter_google_account_and_confirm_twice.png[]
+++ </div></details> +++
...
image::18-back_to_dashboard.png[]
+++ </div></details> +++
...
image::19-go_to_credentials.png[]
+++ </div></details> +++
...
image::22-set_API_key_permissions.png[]
+++ </div></details> +++
...
image::24-select_youtube_API.png[]
+++ </div></details> +++
...
image::25-save_API_restrictions.png[]
+++ </div></details> +++
...
image::26-add_oauth_client_ID.png[]
+++ </div></details> +++
...
image::27-configure_oauth_client_ID.png[]
+++ </div></details> +++
...
image::29-login_with_test_user.png[]
+++ </div></details> +++
...
image::30-not_validated_by_google.png[]
+++ </div></details> +++
...
image::32-website_not_found.png[]
+++ </div></details> +++
